...
Future<List<Object>> calculateChatMessages(
  ...
  DateFormat? timeFormat,
  bool enableImageGallery = true,
  bool simpleUI = false,
  Future<String?> Function(String?)? uriFixup,
}) async {
  ...
  for (var i = messages.length - 1; i >= 0; i--) {
    ...
    chatMessages.insert(0, {
      ...
      'showName': ((notMyMessage && showUserNames && showName) || simpleUI) &&
    ...
    if (message is types.ImageMessage &&
      ...
      if (kIsWeb) {
        ...
        var uri = message.uri;
        if (uriFixup != null) {
          uri = (await uriFixup(uri)) ?? uri;
        }
        gallery.add(PreviewImage(id: message.id, uri: uri));
      }
    }
  }
